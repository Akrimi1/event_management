...
<body id="page-top">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav text-uppercase ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="index.php#inscription">Inscription</a>
          </li>
          <li class="nav-item">
  ...
  <header class="masthead">
    <div class="container">
      <div class="intro-text">
        ...
        <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="index.php#inscription">Inscrivez-Vous</a>
      </div>
    </div>
  </header>
  ...
  <section id="connexion">
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-12">
          <form id="connexion" name="connexion" method="POST" action="../../Controller/verifsession.php">
          ...
          <div class="col-lg-12 text-center">
            ...
            <input id="connexion" class="btn btn-primary btn-xl text-uppercase" type="submit" value="Connexion"/>
    ...
    <div class="row">
      <div class="col-md-4 col-sm-6 evenement-item">
        <a class="evenement-link" data-toggle="modal" href="#evenementModal1">
          ...
          <img class="img-fluid" src="img/evenement/01-thumbnail.jpg" alt="">
        </a>
      ...
      <div class="col-md-4 col-sm-6 evenement-item">
        <a class="evenement-link" data-toggle="modal" href="#evenementModal2">
          ...
          <img class="img-fluid" src="img/evenement/02-thumbnail.jpg" alt="">
        </a>
        <div class="evenement-caption">
          <h4>Explore</h4>
